...
- Assignment 1 is a Group Assignment!
    - Teach each other to code some simulations!\lspace
- See discussion posts!
    - Bonus marks for one good post + one good reply.
        - Can also get for one post + two short replies.
...
In mathematical statistics, you'll learn that expressions like:
$$
\frac{X - \mu}{s/\sqrt{n}}
$$
are called **pivotal quantities**, and are very useful for a great many things!
:::
