...
However, there are also times where we want to check *all* predictors one-by-one. 

This is much less common than the textbook may lead you to believe (and I strongly recommend against it), but it still happens.
