...
- Raw: a one unit increase in $x$ leads to a 1 unit increase in $y$.
    - Slopes are in the units of the predictors.
    - Assuming all other predictors are held constant.\lspace
- Standardized: a one *standard deviation* increase in $x$ leads to a 1 *unit* increase in $y$
