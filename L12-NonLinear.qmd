...
#| echo: true
#| eval: false
shiny::runGitHub(repo = "DB7-CourseNotes", 
    subdir = "Apps/polyFit")
```
...
Play around with the polynomial order in the following code to try and get a good fit! Then, reveal the solution below.
