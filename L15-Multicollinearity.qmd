...
x1_x2_corr <- 0.8 # Change me!
x1_x3_corr <- 0 # Change me!
coef_of_x2_in_y <- 2 # Change me too!
X <- mvrnorm(n = n, mu = c(0, 0, 0), 
        Sigma = matrix(c(
                1,          x1_x2_corr, x1_x3_corr,
                x1_x2_corr, 1,          0,
                x1_x3_corr, 0,          1),
            nrow = 3))
mydata <- data.frame(
    y = 0 + 4*X[, 1] + coef_of_x2_in_y*X[, 2] +
        2 * X[, 3] + rnorm(n, 0, 5),
