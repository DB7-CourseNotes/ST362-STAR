...
- Negative - P(buys MM) decreases as MM becomes more expensive relative to CH.
- Odds Ratio is exp(-2.82) = 0.0596.
    ...
    - For an "equal price" versus "50 cents" comparison, customers are exp(-1.41) = 24% more likely to buy MM.
...
We're going to start with an overspecified model, and see what LASSO which predictors LASSO will select.
...
That's an increase in price difference of \$0.27.
